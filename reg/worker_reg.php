...
<body>
	<div class="main">
		...
		<div class="reg-block">
			...
			<?php 
				echo "<div class='lines' knarea_p>" . $selector . "</div>";

				echo "<div class='lines' id='workt_p'></div>";
			?>
			<div class="lines">
			   <div class="text">Придумайте логин:<?php echo $login_msg; ?></div> <input type="text" name="login" size="43">
			</div>
			...
			<div class="lines">
				<div class="text">Приложите ваше резюме:<?php echo $doc_msg; ?></div> <input type="file" name="curvitae" > 
			</div>
